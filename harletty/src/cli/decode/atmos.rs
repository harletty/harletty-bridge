...
pub fn create_damf_header_file(
    ...
    let mut damf_data = Data::with_oamd_payload(oamd, base_path, source_codec, crate::CREATION_TOOL);
...
pub fn rewrite_damf_header_for_bed_conform(
    ...
    let mut damf_data = Data::with_oamd_payload_bed_conform(oamd, base_path, source_codec, crate::CREATION_TOOL);
